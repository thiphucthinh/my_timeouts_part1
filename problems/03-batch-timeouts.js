...
// This code works but doesn't pass the test:
// "should return an array containing the Timeout objects
// that are returned by each call to setTimeout"

// function batchTimeouts(callbacks, delays) {
//   let timeoutObjs = [];
//   for (let i = 0; i < callbacks.length; i++) {
//     setTimeout(callbacks[i], delays[i]);
//     timeoutObjs.push({ [callbacks[i]]: delays[i] });
// The use of square brackets [...] in this context callbacks[i] is not about putting something into an array.
// Instead, it's a JavaScript syntax for creating computed property names in object literals.
//   }
//   return timeoutObjs;
// }
